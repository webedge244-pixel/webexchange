...
const Register: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Create Account - NexusX</title>
        <meta name="description" content="Create your NexusX account and start trading cryptocurrencies today." />
      </Helmet>
          ...
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center gap-2 mb-6">
              <div className="w-10 h-10 rounded-lg bg-secondary/20 neon-border-purple flex items-center justify-center">
                <span className="font-orbitron font-bold text-secondary">NX</span>
              </div>
            </Link>
            <h1 className="font-orbitron font-bold text-3xl mb-2">Create Account</h1>
            <p className="text-muted-foreground">Join the future of crypto trading</p>
          </div>

          {/* Form */}
          <form onSubmit={handleSubmit} className="glass-card-purple p-8 space-y-5">
            {/* Name */}
            ...
            <p className="text-center text-muted-foreground">
              ...
              <Link to="/sign-in" className="text-secondary hover:underline">
                Sign in
              </Link>
            </p>
          </form>
