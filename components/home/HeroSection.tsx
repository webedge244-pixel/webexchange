      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-muted-foreground">Secure • Fast • Decentralized</span>
          </div>
          ...
          >
            The Future of{' '}
            <span className="text-primary text-glow-blue">Crypto</span>{' '}
            Exchange
          </h1>
          ...
          >
            Trade, swap, and manage your digital assets with industry-leading security 
            and lightning-fast transactions. Built for the next generation of traders.
          </p>
          ...
          >
            {isAuthenticated ? (
              <Link to="/connect-wallet">
                <Button size="lg" className="btn-primary-glow text-lg px-8 py-6 gap-2">
                  Connect Wallet
              ...
              <>
                ...
                <Link to="/sign-in">
                  <Button size="lg" variant="outline" className="text-lg px-8 py-6 neon-border-purple hover:bg-secondary/10">
                    Sign In
                  </Button>
                </Link>
              </>
